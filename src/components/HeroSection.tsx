...
export function HeroSection() {
  return (
    <section id="home" className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-b from-sage-light/60 via-sage-light/40 to-sage-light/80 z-10" />
      ...
      <div className="relative z-20 text-center flex flex-col items-center px-4 max-w-4xl mx-auto mt-20">
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-bold text-forest-dark mb-6 tracking-tight"
        >
          <motion.span 
            className="block" 
          ...
          <motion.span 
            className="block text-sage-button" 
            variants={{ hidden: { y: 20, opacity: 0 }, visible: { y: 0, opacity: 1 } }}
          >
            will make you smile
          </motion.span>
        ...
        <motion.h2 
          ...
          className="text-2xl md:text-3xl font-medium text-forest-dark/90 mb-6"
        >
        ...
        <motion.p 
          ...
          className="text-lg md:text-xl text-forest-dark/70 max-w-2xl leading-relaxed"
        >
